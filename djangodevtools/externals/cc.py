#!/usr/bin/env python
"""
    source : http://www.traceback.org/2008/03/31/measuring-cyclomatic-complexity-of-python-code/
    author : David Stanek, www.traceback.org 
"""
import compiler
...
class Stats(object):
    ...
    def __iter__(self):
        for x in (self.name, self.classes, self.functions, self.complexity):
            yield x 
